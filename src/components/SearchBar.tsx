    ...
    <div className="max-w-7xl mx-auto px-4 pt-4">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2.5 pl-10 rounded-xl border border-brand-cream-dark dark:border-neutral-700 bg-white dark:bg-brand-card text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-neutral-600 focus:ring-2 focus:ring-brand-red/50 focus:border-brand-red outline-none transition-colors text-sm"
        />
