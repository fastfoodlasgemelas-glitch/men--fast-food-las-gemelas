...
export default function ReservationModal({ isOpen, onClose }: ReservationModalProps) {
  ...
  const buildWhatsAppUrl = () => {
    const mensaje = `Hola Las Gemelas, quisiera hacer una reservaci\u00F3n:\n- Nombre: ${form.nombre}\n- Fecha: ${form.fecha}\n- Hora: ${form.hora}\n- Personas: ${form.personas}`;
    return `https://wa.me/50369922006?text=${encodeURIComponent(mensaje)}`;
  };
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={handleClose}>
      ...
      <div
        className="relative bg-white dark:bg-brand-card rounded-xl shadow-2xl w-full max-w-md p-6 border border-brand-cream-dark dark:border-neutral-800"
      ...
      >
        ...
        <h2 className="text-xl font-heading tracking-wide text-brand-dark dark:text-white mb-4">
          Reservaciones
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-neutral-700 bg-white dark:bg-brand-dark text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-brand-red/50 focus:border-brand-red outline-none transition-colors"
